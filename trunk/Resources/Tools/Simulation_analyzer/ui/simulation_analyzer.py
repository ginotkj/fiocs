...
#
# Created: Wed Apr 21 19:57:05 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 561, 451))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.doubleSpinBox.setMaximum(3.3)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_6, 2, 6, 1, 1)
        ...
        self.treeView.setGeometry(QtCore.QRect(580, 140, 271, 321))
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL("clicked()"), MainWindow.update_status)
        QtCore.QObject.connect(self.lineEdit, QtCore.SIGNAL("returnPressed()"), MainWindow.list_dir)
        ...
        MainWindow.setTabOrder(self.radioButton_2, self.spinBox_4)
        ...
        MainWindow.setTabOrder(self.spinBox_3, self.spinBox)
        MainWindow.setTabOrder(self.spinBox, self.tabWidget)
        MainWindow.setTabOrder(self.tabWidget, self.spinBox_6)
        MainWindow.setTabOrder(self.spinBox_6, self.doubleSpinBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.headerItem().setText(1, QtGui.QApplication.translate("MainWindow", "Size", None, QtGui.QApplication.UnicodeUTF8))
        self.treeWidget.headerItem().setText(2, QtGui.QApplication.translate("MainWindow", "Type", None, QtGui.QApplication.UnicodeUTF8))
